...
export function InvestmentAnalysis() {
  return (
    <Container className="mt-24 sm:mt-32 lg:mt-40">
      ...
      <FadeIn>
        <div className="mb-16">
          <h3 className="mb-8 text-center text-xl font-semibold text-neutral-950">
            初期投資成本明細
          </h3>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
              {monthlyOperating.map((item, index) => (
                ...
                >
                  ...
                  <div className="my-2 text-lg font-bold text-neutral-950">
                    {item.amount}
                  </div>
                  <div className="text-sm text-neutral-600">
                    {item.description}
      ...
      <FadeIn>
        <div className="mb-16">
          ...
          <div className="overflow-x-auto">
            <table className="w-full overflow-hidden rounded-2xl bg-white shadow-sm">
              <thead className="bg-neutral-50">
                <tr>
                  <th className="px-6 py-4 text-left font-semibold text-neutral-950">
                    時期
                  </th>
                  <th className="px-6 py-4 text-left font-semibold text-neutral-950">
                    日銷量
              ...
              <tbody>
                {revenueProjection.map((row, index) => (
                  <tr key={index} className="border-t border-neutral-100">
                    ...
                    <td className="px-6 py-4 font-semibold text-neutral-950">
                      {row.revenue}
                    </td>
                    <td className="px-6 py-4 font-semibold text-neutral-950">
                      {row.profit}
