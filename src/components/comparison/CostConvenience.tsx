...
const CostCalculator = () => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg">
      <h3 className="text-lg font-semibold text-neutral-950 mb-6">成本計算器</h3>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="w-16 text-center">
            <input
              ...
              value={petWeight}
              onChange={(e) => setPetWeight(Number(e.target.value))}
              className="w-full text-center border border-neutral-300 rounded px-2 py-1 text-sm"
              min="1"
              max="50"
            />
          </div>
      ...
      <div className="mb-6 p-4 bg-neutral-50 rounded-lg">
        <div className="text-sm text-neutral-600 mb-1">每日建議餵食量</div>
        <div className="text-2xl font-bold text-neutral-950">{calculation.dailyPortion}g</div>
      </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        <h4 className="font-medium text-blue-800 mb-3">年度成本分析</h4>
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <span className="text-blue-700">鮮食便當年費</span>
            <span className="font-medium">NT$ {calculation.yearlyFreshFood.toFixed(0)}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-blue-700">傳統乾糧年費</span>
            <span className="font-medium">NT$ {calculation.yearlyDryFood.toFixed(0)}</span>
          </div>
          <div className="flex justify-between border-t border-blue-200 pt-2">
            <span className="text-blue-700">年度差額</span>
            <span className="font-medium text-blue-800">
              NT$ {(calculation.yearlyFreshFood - calculation.yearlyDryFood).toFixed(0)}
            </span>
          </div>
          <div className="flex justify-between text-green-700">
            <span>潛在醫療費用節省</span>
            <span className="font-medium">NT$ {calculation.potentialVetSavings.toFixed(0)}</span>
          </div>
        </div>
      </div>
    </div>
...
const DeliveryOptions = () => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg">
      <h3 className="text-lg font-semibold text-neutral-950 mb-6">配送方案</h3>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        <h4 className="font-medium text-blue-800 mb-2">配送優勢</h4>
...
const ConvenienceComparison = () => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg">
      <h3 className="text-lg font-semibold text-neutral-950 mb-6">便利性對比</h3>
      ...
      <div className="space-y-6">
        {comparisonItems.map((item, index) => (
          <motion.div
            ...
            transition={{ delay: index * 0.1 }}
          >
            <h4 className="font-medium text-neutral-950 mb-4">{item.aspect}</h4>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* 鮮食便當 */}
              <div className="p-4 bg-green-50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-green-800">鮮食便當</span>
                  <div className="flex items-center">
                    {[...Array(10)].map((_, i) => (
                      <svg
                        key={i}
                        className={`w-3 h-3 ${
                          i < item.freshFood.score ? 'text-green-500' : 'text-neutral-300'
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                    ...
                    <span className="ml-1 text-sm text-green-700">{item.freshFood.score}/10</span>
                  </div>
                </div>
                <p className="text-sm text-green-700 mb-2">{item.freshFood.description}</p>
              ...
              <div className="p-4 bg-orange-50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-orange-800">傳統乾糧</span>
                  <div className="flex items-center">
                    {[...Array(10)].map((_, i) => (
                      <svg
                        key={i}
                        className={`w-3 h-3 ${
                          i < item.dryFood.score ? 'text-orange-500' : 'text-neutral-300'
                        }`}
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                    ...
                    <span className="ml-1 text-sm text-orange-700">{item.dryFood.score}/10</span>
                  </div>
                </div>
                <p className="text-sm text-orange-700 mb-2">{item.dryFood.description}</p>
...
export function CostConvenience() {
  const [activeTab, setActiveTab] = useState<'cost' | 'delivery' | 'convenience'>('cost')
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        {activeTab === 'cost' && (
          <>
            ...
            <FadeIn>
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <h3 className="text-lg font-semibold text-neutral-950 mb-6">長期價值分析</h3>
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-lg">
                    <h4 className="font-medium text-green-800 mb-2">健康投資回報</h4>
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-medium text-blue-800 mb-2">隱藏成本比較</h4>
        ...
        {activeTab === 'delivery' && (
          <>
            ...
            <FadeIn>
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <h3 className="text-lg font-semibold text-neutral-950 mb-6">配送服務特色</h3>
                <div className="space-y-6">
                  <div>
                    <h4 className="font-medium text-neutral-950 mb-3">冷鏈配送系統</h4>
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div className="p-3 bg-blue-50 rounded-lg">
                        <div className="text-2xl font-bold text-blue-600">-18°C</div>
                  ...
                  <div>
                    <h4 className="font-medium text-neutral-950 mb-3">智能包裝技術</h4>
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-neutral-950 mb-2">長期經濟效益</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-neutral-950 mb-2">便利服務體驗</h4>
              <p className="text-sm text-neutral-600">
                定期配送到府，無需擔心斷糧，
                專業客服隨時協助
              </p>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-neutral-950 mb-2">愛的投資</h4>
              <p className="text-sm text-neutral-600">
                為毛孩提供最好的營養，
                是對家人健康的最佳投資
              </p>
