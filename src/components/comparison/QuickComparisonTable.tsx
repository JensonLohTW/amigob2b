...
export function QuickComparisonTable() {
  return (
    <Container className="mt-24 sm:mt-32 lg:mt-40" id="comparison-table">
      <SectionIntro
        eyebrow="快速對比"
        title="一目了然的關鍵差異"
        className="mb-16"
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="text-center">
                        <div
                          className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium ${statusColors[item.freshFood.status]}`}
                        >
                    ...
                    <td className="px-6 py-4">
                      <div className="text-center">
                        <div
                          className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium ${statusColors[item.dryFood.status]}`}
                        >
