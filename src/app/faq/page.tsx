...
// 由於這是客戶端組件，我們需要將 metadata 移到 layout 或使用其他方式
// 這裡我們先註釋掉，稍後會處理
// export const metadata: Metadata = {
//   title: '常見問題 - AMIGO 寵物鮮食自動販賣機',
//   description: '查看 AMIGO 寵物鮮食自動販賣機加盟的常見問題，包含投資相關、技術規格、營運管理、客戶支援等詳細解答。',
// }
        ...
        <FadeInStagger>
          <FadeIn>
            <FAQStats
              ...
              categoryCount={selectedCategory ? categoryStats[selectedCategory] : undefined}
              ...
              {faqCategories.map((category) => (
                <FadeIn key={category.id}>
                  <button
                    ...
                    className="group relative p-6 bg-white rounded-2xl border border-neutral-200 hover:border-neutral-300 hover:shadow-lg transition-all duration-200 text-left w-full"
                  >
                    ...
                    <h3 className="font-display text-lg font-semibold text-neutral-950 mb-2 group-hover:text-neutral-700 transition-colors">
                      {category.name}
                    </h3>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-colors"
                >
                ...
                <a
                  href="/apply"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-neutral-900 font-semibold rounded-full border border-neutral-300 hover:bg-neutral-50 transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
