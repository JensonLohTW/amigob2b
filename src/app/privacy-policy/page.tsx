...
export const metadata: Metadata = {
  ...
  description:
    '了解 AMIGO 如何收集、使用和保护您的个人资料。我们承诺遵循台湾个资法规定，保障您的隐私权益。',
}
  ...
  return (
    <RootLayout>
      <PageIntro eyebrow="隐私政策" title="保护您的个人资料是我们的承诺">
        <p>
          AMIGO
          宠物鲜食科技有限公司（以下简称「本公司」）深知个人资料保护的重要性，
        ...
        <div className="mx-auto max-w-4xl">
          <FadeIn>
            <div className="prose prose-neutral max-w-none">
              {/* 最后更新日期 */}
              <div className="mb-12 rounded-2xl border border-blue-200 bg-blue-50 p-6">
                <p className="mb-2 text-sm font-semibold text-blue-800">
                  最后更新日期
                </p>
                <p className="mb-0 text-blue-700">2025年1月25日</p>
              </div>

              {/* 第一章：适用范围 */}
              <section className="mb-12">
                <h2 className="mb-6 border-b border-neutral-200 pb-3 text-2xl font-bold text-neutral-950">
                  第一章 适用范围
                </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li>
                        • <strong>直接收集</strong>
                        ：通过加盟申请表单、联络表单、电话咨询等方式
                      </li>
                      <li>
                        • <strong>自动收集</strong>：通过
                        Cookie、网站分析工具等技术手段
                      </li>
                      <li>
                        • <strong>第三方提供</strong>
                        ：通过合法的第三方管道获得（如商业伙伴推荐）
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div className="rounded-xl border border-neutral-200 p-6">
                      <h4 className="mb-3 font-semibold text-neutral-950">
                        🤝 加盟服务
                      </h4>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ul className="mt-3 space-y-2">
                      <li>
                        • <strong>Google Analytics</strong>：网站流量分析
                      </li>
                      <li>
                        • <strong>电子邮件服务</strong>：发送通知和营销邮件
                      </li>
                      <li>
                        • <strong>客服系统</strong>：处理客户咨询
                      </li>
                      <li>
                        • <strong>支付系统</strong>：处理付款事宜
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="mb-4">我们仅在必要期间内保存您的个人资料：</p>
                    <ul className="space-y-2">
                      <li>
                        • <strong>加盟申请资料</strong>：申请处理完成后保存 3 年
                      </li>
                      <li>
                        • <strong>客户服务记录</strong>：服务结束后保存 2 年
                      </li>
                      <li>
                        • <strong>营销资料</strong>：取消订阅后立即删除
                      </li>
                      <li>
                        • <strong>网站使用记录</strong>：保存 1 年
                      </li>
                      <li>
                        • <strong>法律要求资料</strong>：依法律规定保存
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl border border-blue-200 bg-blue-50 p-6">
                    ...
                    <div className="space-y-2 text-sm text-blue-700">
                      <p>
                        <strong>重大变更</strong>
                        ：我们将通过电子邮件、网站公告或其他适当方式通知您
                      </p>
                      <p>
                        <strong>一般变更</strong>
                        ：更新后的政策将在网站上公布，并标注最后更新日期
                      </p>
                      <p>
                        <strong>生效时间</strong>：更新后的政策将在公布后 30
                        天生效
                      </p>
                    </div>
                  </div>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-6">
                      <h4 className="mb-4 font-semibold text-neutral-950">
                        📞 联络资讯
                      </h4>
                  ...
                  <div className="rounded-xl border border-green-200 bg-green-50 p-6">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-lg border border-green-300 bg-white px-4 py-2 text-sm font-medium text-green-700 transition-colors hover:bg-green-50"
                      >
                        📞 立即致电
                      </a>
                      <a
              ...
              <div className="mt-16 border-t border-neutral-200 pt-8">
                <div className="text-center text-sm text-neutral-500">
                  <p className="mb-2">本隐私政策最后更新日期：2025年1月25日</p>
                  <p>© 2025 AMIGO 宠物鲜食科技有限公司 版权所有</p>
                </div>
              </div>
            </div>
          </FadeIn>
