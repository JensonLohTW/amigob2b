...
export const metadata: Metadata = {
  title: '產品系列',
  description: '專業寵物鮮食產品系列，從幼齡到樂齡，從日常營養到功能性需求，每一款都經過專業獸醫師和營養師精心調配。',
}
        ...
        <FadeIn>
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-neutral-950 mb-2">人食等級製程</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-neutral-950 mb-2">專業營養配方</h3>
              <p className="text-neutral-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-neutral-950 mb-2">新鮮現做</h3>
              <p className="text-neutral-600">
