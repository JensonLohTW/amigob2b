    ...
    <>
      ...
      >
        <p>
          ...
          每一款都經過專業獸醫師和營養師精心調配，確保您的毛孩獲得最優質的營養。        </p>
      </SectionIntro>
...
export default async function Home() {
  ...
  return (
    <RootLayout>
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          ...
          <p className="mt-6 text-xl text-neutral-600">
            革命性的寵物鮮食自動販賣機，結合 AI 智能管理與人食等級製程。
            8 個月回本，月毛利超過 7 萬元，搶佔高雄 400 台機台商機。          </p>
        </FadeIn>
      </Container>
      ...
      <Container className="mt-24 sm:mt-32 lg:mt-40">
        ...
        <FadeIn>
          <div className="mt-16 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button href="/apply" className="border border-neutral-300 bg-white text-neutral-950 hover:bg-neutral-50">
              申請加盟合作
            </Button>
          </div>
        </FadeIn>
      ...
      >
        AMIGO 的自動販賣機讓我們的門市營收增加了 30%，
        客戶可以 24 小時購買新鮮的寵物食品，
        而且 AI 管理系統讓我們完全不用擔心庫存問題。
      </Testimonial>
